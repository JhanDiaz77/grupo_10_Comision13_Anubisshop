...
router.get('/list', adminProductsController.list);
/* GET - muestra Formulario de Agregar producto */
router.get('/add', adminProductsController.productAdd);
/* POST  CREA procesa informacion de formulario de agregar producto */
router.post('/add',uploadFile.single('image'), adminProductsController.productCreate)
/* GET - Editar producto */
router.get('/list/editar/:id', adminProductsController.productEdit);
